...
function Privacy(props) {
    return (
			<div>
				...
				<ul>
					...
					<li>
						<p>
							...
							in this Agreement) refers to Keita Beauty.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Keita Beauty, accessible from{' '}
							<a
								href='https://keita-beauty-frontend.vercel.app/'
								rel='external nofollow noopener'
								target='_blank'>
								https://keita-beauty-frontend.vercel.app/
							</a>
						</p>
					</li>
					<li>
				...
				<ul>
					<li>By email: Tishtanya.Shaw24@gmail.com</li>
				</ul>
			</div>
		);
}
